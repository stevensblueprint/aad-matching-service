...
def generate_responses(mentee_directory, mentor_directory):
    ...
    for mentee in mentee_directory:
        ...
        new_mentee_row = {
            ...
            "To which gender identity do you most identify?": generate_gender(
                ["Male", "Female", "Nonbinary/Fluid/Gender Queer"], [0.4, 0.4, 0.2]
            ),
            "Please indicate if you have a preference for what gender your mentor/mentee is:": generate_gender(
    ...
    for mentor in mentor_directory:
        ...
        new_mentor_row = {
            ...
            "How much do you value a structured mentoring relationship (e.g., goal setting, progress tracking)?": generate_rating_question(),
            "How important is frequent communication (e.g., weekly or bi-weekly) in a mentoring relationship?": generate_rating_question(),
            "Select if you are a Kin Mentor or Kin Mentee": "Kin Mentor",
            "Would you be open to the possibility of having 2 Kin Mentees?": random.choice(
                ["Yes", "No"]
            ),  # START OF MENTOR QUESTIONS
...
def generate_gender(choices, weights):
    """
    To acurately represent gender distribution in the matching form,
    provide the choices and than the typical demographic percentages as weights
    """
