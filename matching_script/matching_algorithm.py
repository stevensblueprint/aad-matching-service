...
class NameParser:
  def __init__(self, pairs, mentors, mentees, mentor_preferences, mentee_preferences, num_people):
    self.pairs = pairs
  ...
  def parse(self):
    ...
    for i in range(0,self.num_people):
      ...
      if mentee_id in mentor_pref:
        self.pairs.loc[i,'Mentor Preference Number'] = mentor_pref.index(mentee_id) + 1
